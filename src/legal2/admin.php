<?php
session_start();
if (isset($_SESSION["legal2"]["status"]) && ($_SESSION["legal2"]["status"] == "admin")) {
        ...
        switch ($_GET["module"]) {
            ...
            case "setup": {
                ...
                if (!isset($_GET["action"])) {
                    ...
                    switch ($_GET["action"]) {
                        case "new": {
                            $admin->newNumber($_POST['firstnumber'], $_SESSION['legal2']['id']);
                            break;
                        }
                        case "waybill": {
                            include_once "templates/header.html";
                        ...
                        case "newwaybill": {
                            $admin->newWaybillNumber($_POST['firstnumber'], $_SESSION['legal2']['id']);
                            break;
                        }
                        default: {
                            break;
                ...
                if (isset($_GET["action"])) {
                    switch ($_GET["action"]) {
                        case "document": {
                            ...
                            $portal->where = " WHERE uid='" . $_SESSION['legal2']['id'] . "'";
                            $portal->limit = " LIMIT " . portal::page * $portal->page . "," . portal::page;
                            $portal->href = "admin.php?module=number&action=document";
                            if (isset($_GET["nid"])) {
                                $portal->showGetForm($_SESSION['legal2']['id'], $_GET["nid"]);
                            } else {
                                $portal->showGetForm($_SESSION['legal2']['id']);
                            }
                            include_once "templates/footer.html";
                            break;
                        ...
                        case "waybill": {
                            ...
                            if (isset($_GET["nid"])) {
                                ...
                                include_once "templates/header.html";
                                $portal->getDocNumberForm($_SESSION["legal2"]["id"], 0, $_GET["nid"]);
                                ...
                                if (isset($_GET["error"])) {
                                    $portal = new portal();
                                    include_once "templates/header.html";
                                    $portal->getDocNumberForm($_SESSION["legal2"]["id"], $_GET["error"]);
                                    include_once "templates/footer.html";
                                } else {
                                    $portal = new portal();
                                    if (isset($_GET['page'])) {
                                    ...
                                    $portal->href = "admin.php?module=number&action=waybill";
                                    include_once "templates/header.html";
                                    $portal->getDocNumberForm($_SESSION["legal2"]["id"]);
                                    $portal->makeNavigationDoc();
                                    include_once "templates/footer.html";
                                }
                            }
                        ...
                        case "getd": {
                            include_once("classes/portalClass.php");
                            $portal = new portal();
                            $portal->getNum($_SESSION['legal2']['id'],
                        ...
                        case "getw": {
                            ...
                            $portal = new portal();
                            $result = $portal->getDocNumber($_SESSION["legal2"]["id"], $_POST["comment"]);
            ...
            case "future": {
                ...
                if (isset($_GET["action"])) {
                    switch ($_GET["action"]) {
                        case "get": {
                            $admin->rezerveForFuture($_POST["number"], $_POST["date"], $_SESSION["legal2"]["id"]);
                            break;
                        }
                        case "show": {
                            include_once "templates/header.html";
