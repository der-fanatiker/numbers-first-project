            ...
            if ($username != 'rezerv') {
                ...
                if ($row["blocked"] == '1') {
                    ...
                    if ($row['password'] == $password) {
                        if ($row['status'] == '1') {
                            //echo "ADMIN";
                            $_SESSION['legal2']['status'] = "admin";
                            $_SESSION['legal2']['name'] = $row['name'];
                            $_SESSION['legal2']['id'] = $row['id'];
                            $_SESSION['legal2']['org'] = $row['organization'];
                            //header("Location:admin.php");
                        } else {
                            //echo "USER";
                            $_SESSION['legal2']['status'] = "user";
                            $_SESSION['legal2']['name'] = $row['name'];
                            $_SESSION['legal2']['id'] = $row['id'];
                            $_SESSION['legal2']['org'] = $row['organization'];
