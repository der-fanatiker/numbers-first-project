<?php
session_start();
if (isset($_SESSION["legal1"]["status"]) && ($_SESSION["legal1"]["status"] == "admin")) {
        ...
        switch ($_GET["module"]) {
            ...
            case "setup": {
                ...
                if (!isset($_GET["action"])) {
                    ...
                    switch ($_GET["action"]) {
                        case "new": {
                            $admin->newNumber($_POST['firstnumber'], $_SESSION['legal1']['id']);
                            break;
                        }
                        case "waybill": {
                            include_once "templates/header.html";
                        ...
                        case "newwaybill": {
                            $admin->newWaybillNumber($_POST['firstnumber'], $_SESSION['legal1']['id']);
                            break;
                        }
                        default: {
                            break;
            ...
            case "future": {
                ...
                if (isset($_GET["action"])) {
                    switch ($_GET["action"]) {
                        case "get": {
                            $admin->rezerveForFuture($_POST["number"], $_POST["date"], $_SESSION["legal1"]["id"]);
                            break;
                        }
                        case "show": {
                            include_once "templates/header.html";
