            ...
            if ($username != 'rezerv') {
                ...
                if ($row["blocked"] == '1') {
                    ...
                    if ($row['password'] == $password) {
                        if ($row['status'] == '1') {
                            //echo "ADMIN";
                            $_SESSION['legal3']['status'] = "admin";
                            $_SESSION['legal3']['name'] = $row['name'];
                            $_SESSION['legal3']['id'] = $row['id'];
                            $_SESSION['legal3']['org'] = $row['organization'];
                            //header("Location:admin.php");
                        } else {
                            //echo "USER";
                            $_SESSION['legal3']['status'] = "user";
                            $_SESSION['legal3']['name'] = $row['name'];
                            $_SESSION['legal3']['id'] = $row['id'];
                            $_SESSION['legal3']['org'] = $row['organization'];
